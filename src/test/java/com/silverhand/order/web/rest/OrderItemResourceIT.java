...
import static com.silverhand.order.domain.OrderItemAsserts.*;
import static com.silverhand.order.web.rest.TestUtil.createUpdateProxyForBean;
import static com.silverhand.order.web.rest.TestUtil.sameNumber;
...
import com.silverhand.order.repository.OrderItemRepository;
import com.silverhand.order.repository.search.OrderItemSearchRepository;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity() {
        return new OrderItem().productId(DEFAULT_PRODUCT_ID).quantity(DEFAULT_QUANTITY).unitPrice(DEFAULT_UNIT_PRICE);
    }
    ...
    public static OrderItem createUpdatedEntity() {
        return new OrderItem().productId(UPDATED_PRODUCT_ID).quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE);
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        updatedOrderItem.productId(UPDATED_PRODUCT_ID).quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.productId(UPDATED_PRODUCT_ID).quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE);
