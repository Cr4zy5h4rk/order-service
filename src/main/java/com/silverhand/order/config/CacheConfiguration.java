...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, com.silverhand.order.domain.Order.class.getName(), jcacheConfiguration);
            createCache(cm, com.silverhand.order.domain.Order.class.getName() + ".orderItems", jcacheConfiguration);
            createCache(cm, com.silverhand.order.domain.OrderItem.class.getName(), jcacheConfiguration);
