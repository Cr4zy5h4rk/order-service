...
import com.silverhand.order.broker.KafkaConsumer;
...
public class OrderKafkaResource {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(OrderKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public OrderKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
