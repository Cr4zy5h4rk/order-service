...
/**
 * REST controller for managing {@link com.silverhand.order.domain.OrderItem}.
 */
@RestController
    ...
    public ResponseEntity<OrderItem> partialUpdateOrderItem(
        ...
        Optional<OrderItem> result = orderItemRepository
            ...
            .map(existingOrderItem -> {
                updateIfPresent(existingOrderItem::setProductId, orderItem.getProductId());
                updateIfPresent(existingOrderItem::setQuantity, orderItem.getQuantity());
                updateIfPresent(existingOrderItem::setUnitPrice, orderItem.getUnitPrice());
